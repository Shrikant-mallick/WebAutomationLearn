...
public class Login {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.setProperty("webdriver.chrome.driver", "C:\\MySoftwares\\ChromeDriver\\chromedriver\\chromedriver.exe");
			 ...
			 * parse through all radio buttons and select any specific radio btn 
